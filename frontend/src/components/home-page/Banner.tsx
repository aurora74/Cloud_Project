...
const images = [
    {
        ...
        title: "TOKYO",
        description:
            "The iconic skyline of Tokyo, where futuristic architecture blends seamlessly with traditional Japanese landmarks.",
    },
    {
        id: 2,
        ...
        title: "SINGAPORE",
        description:
            "Singapore is a city of innovation and green spaces. Its skyline is defined by stunning skyscrapers and the futuristic Gardens by the Bay. ",
    },
    {
        id: 3,
        ...
        title: "PARIS",
        description:
            "Paris, the City of Light, is renowned for its elegant streets, artistic heritage, and iconic landmarks like the Eiffel Tower.",
    },
    {
        id: 4,
        ...
        title: "MELBOURNE",
        description:
            "Melbourne, known for its vibrant arts scene, stunning laneways, and eclectic cafes, offers a mix of modern culture and natural beauty.",
    },
];
